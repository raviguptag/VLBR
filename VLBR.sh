...
Usage: VLBR.sh -t backup|restore -d backup_directory [-z GZIP|PARQUET]  [-f table_name_file] [-r resource_pool] -S [SchmeaName] [-A] [-F] [-h] 
    ...
    -u DatabaseUser     : Vertica database user name, default dbadmin
    -w Password         : Vertica database password
    -p DatabasePort     : Vertica database port, default 5433
    -s VerticaHostIP    : Vertica host IP, default value is localhost
